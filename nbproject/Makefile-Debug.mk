...
${OBJECTDIR}/core/utils/json-builder.o: core/utils/json-builder.c 
	${MKDIR} -p ${OBJECTDIR}/core/utils
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall `pkg-config --cflags libcurl`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/utils/json-builder.o core/utils/json-builder.c

${OBJECTDIR}/core/utils/json.o: core/utils/json.c 
	${MKDIR} -p ${OBJECTDIR}/core/utils
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall `pkg-config --cflags libcurl`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/utils/json.o core/utils/json.c
