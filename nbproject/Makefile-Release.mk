...
${OBJECTDIR}/abstraction/permanent-storage/storage_api.o: abstraction/permanent-storage/storage_api.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/abstraction/permanent-storage/storage_api.o abstraction/permanent-storage/storage_api.c

${OBJECTDIR}/abstraction/timing/lhings_time.o: abstraction/timing/lhings_time.c 
	${MKDIR} -p ${OBJECTDIR}/abstraction/timing
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/abstraction/timing/lhings_time.o abstraction/timing/lhings_time.c

${OBJECTDIR}/abstraction/udp-comm/udp_api.o: abstraction/udp-comm/udp_api.c 
	${MKDIR} -p ${OBJECTDIR}/abstraction/udp-comm
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/abstraction/udp-comm/udp_api.o abstraction/udp-comm/udp_api.c

${OBJECTDIR}/core/crypto/base64.o: core/crypto/base64.c 
	${MKDIR} -p ${OBJECTDIR}/core/crypto
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/crypto/base64.o core/crypto/base64.c

${OBJECTDIR}/core/crypto/hmac-sha1.o: core/crypto/hmac-sha1.c 
	${MKDIR} -p ${OBJECTDIR}/core/crypto
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/crypto/hmac-sha1.o core/crypto/hmac-sha1.c

${OBJECTDIR}/core/crypto/memxor.o: core/crypto/memxor.c 
	${MKDIR} -p ${OBJECTDIR}/core/crypto
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/crypto/memxor.o core/crypto/memxor.c

${OBJECTDIR}/core/crypto/sha1.o: core/crypto/sha1.c 
	${MKDIR} -p ${OBJECTDIR}/core/crypto
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/crypto/sha1.o core/crypto/sha1.c

${OBJECTDIR}/core/http-comm/lhings_api.o: core/http-comm/lhings_api.c 
	${MKDIR} -p ${OBJECTDIR}/core/http-comm
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/http-comm/lhings_api.o core/http-comm/lhings_api.c

${OBJECTDIR}/core/lhings.o: core/lhings.c 
	${MKDIR} -p ${OBJECTDIR}/core
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/lhings.o core/lhings.c

${OBJECTDIR}/core/logging/log.o: core/logging/log.c 
	${MKDIR} -p ${OBJECTDIR}/core/logging
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/logging/log.o core/logging/log.c

${OBJECTDIR}/core/stun-messaging/stun_message.o: core/stun-messaging/stun_message.c 
	${MKDIR} -p ${OBJECTDIR}/core/stun-messaging
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/stun-messaging/stun_message.o core/stun-messaging/stun_message.c
...
${OBJECTDIR}/core/utils/lhings_json_api.o: core/utils/lhings_json_api.c 
	${MKDIR} -p ${OBJECTDIR}/core/utils
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/utils/lhings_json_api.o core/utils/lhings_json_api.c

${OBJECTDIR}/core/utils/utils.o: core/utils/utils.c 
	${MKDIR} -p ${OBJECTDIR}/core/utils
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/utils/utils.o core/utils/utils.c
...
${OBJECTDIR}/tests/data_structures_tests.o: tests/data_structures_tests.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/data_structures_tests.o tests/data_structures_tests.c

${OBJECTDIR}/tests/hmac_sha1_test.o: tests/hmac_sha1_test.c 
	${MKDIR} -p ${OBJECTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/hmac_sha1_test.o tests/hmac_sha1_test.c

${OBJECTDIR}/tests/logging_system_tests.o: tests/logging_system_tests.c 
	${MKDIR} -p ${OBJECTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/logging_system_tests.o tests/logging_system_tests.c

${OBJECTDIR}/tests/stun_message_tests.o: tests/stun_message_tests.c 
	${MKDIR} -p ${OBJECTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/stun_message_tests.o tests/stun_message_tests.c
